...
def get_db_connection():
    """Erstellt eine Verbindung zur bestehenden DB (Modus: Read-Write, kein Create)."""
    try:
        # uri=True und mode=rw verhindert das Neuerstellen der Datei
        return sqlite3.connect(f"file:{DB_NAME}?mode=rw", uri=True)
    except sqlite3.OperationalError:
        print("\n[!] FEHLER: Zugriff auf Datenbank verweigert oder Datei fehlt.")
        sys.exit(1)
